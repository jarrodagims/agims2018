...
<body <?php body_class();?>>
  ...
  <div class="content">
    ...
    <div class="content-top">
      ...
      <div class="warning-top">
        <img class="warning-sign" src="<?=IMGURL?>landing-sales/warning-realness.png" alt="Warning Realness Ahead">
      </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="extra-padding">
                  ...
                  <p>People searching for your services want <strong>immediate results</strong>.<br class="d-md-block">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col text-center">
                ...
                <p>You're in an industry where people don't research - such as an: <br class="d-md-block"><span
                    class="brand">HVAC company</span>, or
      ...
      <div class="landing-module-13 ">
        ...
        <div class="landing-module-15">
          ...
          <div class="container">
            ...
            <p>Maybe you know you need SEO - and you want to hit that longer term strategy, but<br class="d-md-block">
              you also
              want
              more business NOW.
            </p>
 ...
 HERE - CHECK IT OUT...">
                ...
                <p class="blurb">With digital advertising, you’re not just throwing a<br class="d-md-block">
    ...
    sees your ads.">
                  ...
                  <p class="blurb bottom-blurb">You are in <strong>control</strong> opportunities<br class="d-md-block">
        ...
        <div class="landing-module-19">
          <div class="ribbon black">
            <img src="<?=IMGURL?>landing-sales/advertise-digitally.svg" alt="Not sure how to advertise digitally?"
              height="124">
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col">
                ...
                <img src="<?=IMGURL?>landing-sales/advertising-game.svg" alt="It's time to up your Advertising Game"
                  height="157">
            ...
            <div class="row">
              <div class="col display-col">
                <div class="social-tab sideways">
                  ...
                  <div class="extra-padding">
                    <p>Display ads utilize images, banners and more to get your message<br class="d-md-block">
                      across. These can show on relevant website across the web, related to<br class="d-md-block">
            ...
            <div class="row">
              <div class="col">
                ...
                <ol class="list-inline">
                  <li class="number1">Target users by their Location, Age, Interest, and Online Behavior.</li>
                  <li class="number2">Choose the dates and times you'd like your ads displayed.</li>
                  <li class="number3">Most importantly, communicate more efficiently.</li>
                  <li class="number4">Alter your ad text any time you want and relay your message at any given time.
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="landing-module-26">
          <div class="container">
            <div class="row">
              <div class="col  black">
                ...
                <p class="blurb">
                  What if you could spend more time with <span class="yellow">your family?</span><br class="d-md-block">
                  What if you had <span class="yellow">more time</span> your business?<br class="d-md-block">
                  What if <span class="yellow">your business</span> could be found with a touch<br class="d-md-block">
                  of a button?</p>
              </div>
            </div>
          ...
          <div class="gray">
            <p>We focus on your marketing solutions so<br class="d-md-block">
        ...
        <div class="landing-module-27">
          <div class="container">
            <div class="row">
              <div class="col">
                <p class="blurb">We are OBSESSED with your growth,<br class="d-md-block">
                  and making you <strong>the absolute</strong><br class="d-md-block">
        ...
        <div class="landing-module-28">
          ...
          <div class="extra-padding">
            <p>Whether you just launched your ribbon cutting party or have been running your<br class="d-md-block">
              business for over 20 years. <span class="red">We tailor our services to each industry and each
                client.</span> </p>
            <p class="blurb">
