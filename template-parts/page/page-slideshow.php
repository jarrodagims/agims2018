    ...
    <div class="container ">
        <div class="row">
            <div class="col text-center">
                <h2>
                    The Brains Behind Your Campaign
                </h2>
            </div>
        </div>
    </div>
...
<section class="slideshow-container">
    <div class="internal-slideshow">
        ...
        <div class="slide" data-cycle-title="Marketing Executive">
            <div>
                ...
                <h3>
                    <span class="g-circle">D</span>
                    <span class="name">Dino Ray Astorga</span>
                    <span class="title">Marketing Executive</span>
                </h3>
            </div>
        </div>
        <div class="slide" data-cycle-title="Social Media Manager">
            <div>
                ...
                <h3>
                    <span class="g-circle">E</span>
                    <span class="name">Erika Menes</span>
        ...
        <div class="slide" data-cycle-title="SEO Web Developer">
            <div>
                ...
                <h3>
                    ...
                    <span class="name">Christopher Zacherl</span>
        ...
        <div class="slide" data-cycle-title="Director of Development">
            <div>
                ...
                <h3>
                    <span class="g-circle">E</span>
                    <span class="name">Eric Rivera</span>
        ...
        <div class="slide" data-cycle-title="Production Leader">
            <div>
                ...
                <h3>
                    <span class="g-circle">A</span>
                    <span class="name">Ashley Singelyn</span>
        ...
        <div class="slide" data-cycle-title="Content Writer & SEO Specialist">
            <div>
                ...
                <h3>
                    ...
                    <span class="name">Otto Nicli</span>
        ...
        <div class="slide" data-cycle-title="Graphic Designer">
            <div>
                ...
                <h3>
                    ...
                    <span class="name">Monica Pappatheodorou</span>
        ...
        <div class="slide" data-cycle-title="Web Developer">
            <div>
                ...
                <h3>
                    <span class="g-circle">J</span>
                    <span class="name">Jarrod Medrano</span>
        ...
        <div class="slide" data-cycle-title="Senior Content Editor">
            <div>
                ...
                <h3>
                    <span class="g-circle">J</span>
                    <span class="name">Jacqueline Gutierrez</span>
        ...
        <div class="slide" data-cycle-title="Business Account Executive">
            <div>
                <div class="slide-container">
                    <img height="246" width="318" src="<?= IMGURL ?>priscilla.jpg" alt="Priscilla" />
                </div>
                <h3>
                    <span class="g-circle">P</span>
                    <span class="name">Priscilla Correa</span>
                    <span class="title">Business Account Executive</span>
                </h3>
            </div>
        </div>
        ...
        <div class="slide" data-cycle-title="Online Presence Specialist">
            <div>
                ...
                <h3>
                    <span class="g-circle">J</span>
                    <span class="name">Jennifer Graves</span>
        ...
        <div class="slide" data-cycle-title="Online Reputation Specialist">
            <div>
                ...
                <h3>
                    ...
                    <span class="name">Brian Hanna</span>
                    <span class="title">Online Reputation Specialist</span>
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <a href=# id="prev3" class="prev">
                    << Prev </a> <div class="cycle-caption">
